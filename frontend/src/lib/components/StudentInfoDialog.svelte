<script lang="ts">
    ...
    function getCountryFlag(country: string): string {
        if (country.toLowerCase().includes('bottom')) {
            return '🏴‍☠️';
        }
        if (country.toLowerCase().includes('usa') || country.toLowerCase().includes('america')) {
            return '🇺🇸';
        }
        return '🌍';
    }
            ...
            <div class="dialog-info-container">
                <table class="student-details-table">
                    ...
                    <tr>
                        ...
                        <td>{student.destinationFaculty}</td>
                    </tr>
                    <tr>
                        <td><strong>Home Faculty:</strong></td>
                        <td>{student.homeFaculty}</td>
                    </tr>
                    <tr>
